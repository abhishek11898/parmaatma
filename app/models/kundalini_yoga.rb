class KundaliniYoga < ApplicationRecord
  ...
  def absolute_image_url
    File.join(KundaliniYoga.images_folder_path, image_name)
  end

  def absolute_video_url
    File.join(KundaliniYoga.videos_folder_path, video)
  end
  ...
  def video_url
    File.join(KundaliniYoga.relative_videos_folder_path, video)
  end
end